...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/1-task195 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/1-task195/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_m1/2-task360 \
   --instruction_file SUPERNI/instructions.json  \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/2-task360 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/2-task360/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_m1/3-task611 \
   --instruction_file SUPERNI/instructions.json \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/3-task611 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/3-task611/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_m1/4-task002 \
   --instruction_file SUPERNI/instructions.json \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/4-task002 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/4-task002/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_m1/5-task224 \
   --instruction_file SUPERNI/instructions.json \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_m1/outputs/5-task224 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
