...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/1-task589 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/1-task589/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_g1/2-task141 \
   --instruction_file SUPERNI/instructions.json  \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/2-task141 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/2-task141/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_g1/3-task618 \
   --instruction_file SUPERNI/instructions.json  \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/3-task618 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/3-task618/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_g1/4-task339 \
   --instruction_file SUPERNI/instructions.json  \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/4-task339 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/4-task339/adapter \
   --data_dir SUPERNI \
   --task_config_dir CL_configs/order/ni_seq_g1/5-task360 \
   --instruction_file SUPERNI/instructions.json \
   --suffix_file SUPERNI/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/ni_seq_g1/outputs/5-task360 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
