...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --output_dir saves/LoraInc/qwen3-8b/trace/outputs/1-cstance \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/trace/outputs/1-cstance/adapter \
   --data_dir TRACE \
   --task_config_dir CL_configs/order/trace/2-fomc \
   --instruction_file TRACE/instructions.json  \
   --suffix_file TRACE/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/trace/outputs/2-fomc \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/trace/outputs/2-fomc/adapter \
   --data_dir TRACE \
   --task_config_dir CL_configs/order/trace/3-meet \
   --instruction_file TRACE/instructions.json  \
   --suffix_file TRACE/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/trace/outputs/3-meet \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/trace/outputs/3-meet/adapter \
   --data_dir TRACE \
   --task_config_dir CL_configs/order/trace/4-py150 \
   --instruction_file TRACE/instructions.json \
   --suffix_file TRACE/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/trace/outputs/4-py150 \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/trace/outputs/4-py150/adapter \
   --data_dir TRACE \
   --task_config_dir CL_configs/order/trace/5-sciqa \
   --instruction_file TRACE/instructions.json \
   --suffix_file TRACE/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/trace/outputs/5-sciqa \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
...
CUDA_VISIBLE_DEVICES=0,1,2,3,4,5,6,7 deepspeed --master_port $port src/run_lorainc.py \
   ...
   --do_predict \
   --predict_with_generate \
   --model_name_or_path saves/LoraInc/qwen3-8b/trace/outputs/5-sciqa/adapter \
   --data_dir TRACE \
   --task_config_dir CL_configs/order/trace/6-numgulecm \
   --instruction_file TRACE/instructions.json  \
   --suffix_file TRACE/instructions.json \
   --instruction_strategy single \
   --output_dir saves/LoraInc/qwen3-8b/trace/outputs/6-numgulecm \
   --per_device_train_batch_size 1 \
   --per_device_eval_batch_size 8 \
   --eval_accumulation_steps 1 \
   --gradient_accumulation_steps 8 \
